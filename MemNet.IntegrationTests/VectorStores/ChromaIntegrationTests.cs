...
/// <summary>
/// Integration tests for ChromaV2VectorStore
/// </summary>
public class ChromaIntegrationTests : VectorStoreTestBase<ChromaV2VectorStore>
{
    protected override ChromaV2VectorStore CreateVectorStore()
    {
        var httpClient = new HttpClient();
        var config = Options.Create(new ChromaV2VectorStoreConfig
        {
